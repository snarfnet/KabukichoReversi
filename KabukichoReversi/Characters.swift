    ...
    static let all: [PlayerID: GameCharacter] = [
        .p1: GameCharacter(
            ...
            lines: .init(
                ...
                onFlip: ["赤にチェンジ", "まとめて返すよ", "流れは私のもの", "その場所、もらうね"],
                onPass: ["今は置けないみたい", "少し待つしかないね", "次で返すから", "ここは様子見"],
                onWin: ["赤い夜の勝ち", "最後まで見てくれてありがとう", "この街では私が強いね", "いい勝負だったよ"],
        ...
        .p2: GameCharacter(
            ...
            lines: .init(
                ...
                onFlip: ["一気にひっくり返す", "緑に染まってきた", "いい感じに決まった", "流れを持っていくね"],
                onPass: ["ちょっと休憩", "今は置ける場所がないね", "次で巻き返す", "まだ酔ってないよ"],
                onWin: ["勝利の一杯だね", "勢いだけじゃないでしょ", "緑の夜、完成", "いい勝負だったよ"],
                onLose: ["もう一本あけるよ", "次は冷静にいく", "今のは油断した", "悔しいけど楽しかった"]
            )
        ),
        .p3: GameCharacter(
            name: "ミユ",
